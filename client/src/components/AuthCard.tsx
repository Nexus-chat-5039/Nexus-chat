...
/**
 * @deprecated Use AmbientBackground + GlassCard directly in auth pages.
...
export default function AuthLayout({ title, subtitle, children }: AuthLayoutProps) {
  return (
    <div className="min-h-screen flex items-center justify-center bg-nexus-bg text-nexus-text p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md rounded-2xl bg-nexus-card/90 backdrop-blur-sm border border-nexus-border p-8 shadow-2xl shadow-black/30 relative z-10">
